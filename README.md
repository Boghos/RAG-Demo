...
⚠️ Do not share this file — your API keys are private.
(You can provide a safe .env.example for reference in GitHub.)
...
The user’s question is embedded and compared against stored vectors.

The top-matching chunks are retrieved.

Gemini uses these chunks as context to generate a grounded answer.
